...
import { Play, Square, Settings, Trash2, FolderOpen, GripVertical, Globe, History, ArrowDown, Loader2, Terminal } from 'lucide-react'
      ...
      <div className="flex items-center gap-1">
        {!isRunning ? (
          ...
          <>
            <button
              onClick={onSelect}
              className="p-1.5 rounded hover:bg-gray-700 text-blue-400 hover:text-blue-300"
              title="打开终端"
            >
              <Terminal size={14} />
            </button>
