...
import { Plus, GripVertical, FolderOpen, Globe } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
        <h1 className="text-lg font-bold">AgentManager <span className="text-xs font-normal text-gray-500">v2.0</span></h1>
        <button
          onClick={onCreateNew}
              ...
              <div className="bg-gray-800 rounded-lg p-3 border border-blue-500 shadow-lg shadow-blue-500/20 w-[260px] opacity-90">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-1 flex-1 min-w-0">
                    <span className="text-gray-500 flex-shrink-0"><GripVertical size={14} /></span>
